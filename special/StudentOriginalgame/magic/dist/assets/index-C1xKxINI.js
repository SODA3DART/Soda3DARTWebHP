 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qg;function Py(){if(Qg)return re;Qg=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),x=Symbol.iterator;function M(N){return N===null||typeof N!="object"?null:(N=x&&N[x]||N["@@iterator"],typeof N=="function"?N:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,S={};function v(N,q,Mt){this.props=N,this.context=q,this.refs=S,this.updater=Mt||E}v.prototype.isReactComponent={},v.prototype.setState=function(N,q){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,q,"setState")},v.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function U(){}U.prototype=v.prototype;function R(N,q,Mt){this.props=N,this.context=q,this.refs=S,this.updater=Mt||E}var L=R.prototype=new U;L.constructor=R,b(L,v.prototype),L.isPureReactComponent=!0;var Z=Array.isArray;function z(){}var O={H:null,A:null,T:null,S:null},Y=Object.prototype.hasOwnProperty;function w(N,q,Mt){var X=Mt.ref;return{$$typeof:r,type:N,key:q,ref:X!==void 0?X:null,props:Mt}}function T(N,q){return w(N.type,q,N.props)}function W(N){return typeof N=="object"&&N!==null&&N.$$typeof===r}function at(N){var q={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(Mt){return q[Mt]})}var F=/\/+/g;function k(N,q){return typeof N=="object"&&N!==null&&N.key!=null?at(""+N.key):q.toString(36)}function st(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(z,z):(N.status="pending",N.then(function(q){N.status==="pending"&&(N.status="fulfilled",N.value=q)},function(q){N.status==="pending"&&(N.status="rejected",N.reason=q)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function B(N,q,Mt,X,ut){var Tt=typeof N;(Tt==="undefined"||Tt==="boolean")&&(N=null);var yt=!1;if(N===null)yt=!0;else switch(Tt){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(N.$$typeof){case r:case t:yt=!0;break;case g:return yt=N._init,B(yt(N._payload),q,Mt,X,ut)}}if(yt)return ut=ut(N),yt=X===""?"."+k(N,0):X,Z(ut)?(Mt="",yt!=null&&(Mt=yt.replace(F,"$&/")+"/"),B(ut,q,Mt,"",function(J){return J})):ut!=null&&(W(ut)&&(ut=T(ut,Mt+(ut.key==null||N&&N.key===ut.key?"":(""+ut.key).replace(F,"$&/")+"/")+yt)),q.push(ut)),1;yt=0;var Yt=X===""?".":X+":";if(Z(N))for(var Xt=0;Xt<N.length;Xt++)X=N[Xt],Tt=Yt+k(X,Xt),yt+=B(X,q,Mt,Tt,ut);else if(Xt=M(N),typeof Xt=="function")for(N=Xt.call(N),Xt=0;!(X=N.next()).done;)X=X.value,Tt=Yt+k(X,Xt++),yt+=B(X,q,Mt,Tt,ut);else if(Tt==="object"){if(typeof N.then=="function")return B(st(N),q,Mt,X,ut);throw q=String(N),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.")}return yt}function Q(N,q,Mt){if(N==null)return N;var X=[],ut=0;return B(N,X,"","",function(Tt){return q.call(Mt,Tt,ut++)}),X}function V(N){if(N._status===-1){var q=N._result;q=q(),q.then(function(Mt){(N._status===0||N._status===-1)&&(N._status=1,N._result=Mt)},function(Mt){(N._status===0||N._status===-1)&&(N._status=2,N._result=Mt)}),N._status===-1&&(N._status=0,N._result=q)}if(N._status===1)return N._result.default;throw N._result}var ft=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)},pt={map:Q,forEach:function(N,q,Mt){Q(N,function(){q.apply(this,arguments)},Mt)},count:function(N){var q=0;return Q(N,function(){q++}),q},toArray:function(N){return Q(N,function(q){return q})||[]},only:function(N){if(!W(N))throw Error("React.Children.only expected to receive a single React element child.");return N}};return re.Activity=_,re.Children=pt,re.Component=v,re.Fragment=i,re.Profiler=l,re.PureComponent=R,re.StrictMode=s,re.Suspense=m,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=O,re.__COMPILER_RUNTIME={__proto__:null,c:function(N){return O.H.useMemoCache(N)}},re.cache=function(N){return function(){return N.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(N,q,Mt){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var X=b({},N.props),ut=N.key;if(q!=null)for(Tt in q.key!==void 0&&(ut=""+q.key),q)!Y.call(q,Tt)||Tt==="key"||Tt==="__self"||Tt==="__source"||Tt==="ref"&&q.ref===void 0||(X[Tt]=q[Tt]);var Tt=arguments.length-2;if(Tt===1)X.children=Mt;else if(1<Tt){for(var yt=Array(Tt),Yt=0;Yt<Tt;Yt++)yt[Yt]=arguments[Yt+2];X.children=yt}return w(N.type,ut,X)},re.createContext=function(N){return N={$$typeof:f,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:c,_context:N},N},re.createElement=function(N,q,Mt){var X,ut={},Tt=null;if(q!=null)for(X in q.key!==void 0&&(Tt=""+q.key),q)Y.call(q,X)&&X!=="key"&&X!=="__self"&&X!=="__source"&&(ut[X]=q[X]);var yt=arguments.length-2;if(yt===1)ut.children=Mt;else if(1<yt){for(var Yt=Array(yt),Xt=0;Xt<yt;Xt++)Yt[Xt]=arguments[Xt+2];ut.children=Yt}if(N&&N.defaultProps)for(X in yt=N.defaultProps,yt)ut[X]===void 0&&(ut[X]=yt[X]);return w(N,Tt,ut)},re.createRef=function(){return{current:null}},re.forwardRef=function(N){return{$$typeof:d,render:N}},re.isValidElement=W,re.lazy=function(N){return{$$typeof:g,_payload:{_status:-1,_result:N},_init:V}},re.memo=function(N,q){return{$$typeof:p,type:N,compare:q===void 0?null:q}},re.startTransition=function(N){var q=O.T,Mt={};O.T=Mt;try{var X=N(),ut=O.S;ut!==null&&ut(Mt,X),typeof X=="object"&&X!==null&&typeof X.then=="function"&&X.then(z,ft)}catch(Tt){ft(Tt)}finally{q!==null&&Mt.types!==null&&(q.types=Mt.types),O.T=q}},re.unstable_useCacheRefresh=function(){return O.H.useCacheRefresh()},re.use=function(N){return O.H.use(N)},re.useActionState=function(N,q,Mt){return O.H.useActionState(N,q,Mt)},re.useCallback=function(N,q){return O.H.useCallback(N,q)},re.useContext=function(N){return O.H.useContext(N)},re.useDebugValue=function(){},re.useDeferredValue=function(N,q){return O.H.useDeferredValue(N,q)},re.useEffect=function(N,q){return O.H.useEffect(N,q)},re.useEffectEvent=function(N){return O.H.useEffectEvent(N)},re.useId=function(){return O.H.useId()},re.useImperativeHandle=function(N,q,Mt){return O.H.useImperativeHandle(N,q,Mt)},re.useInsertionEffect=function(N,q){return O.H.useInsertionEffect(N,q)},re.useLayoutEffect=function(N,q){return O.H.useLayoutEffect(N,q)},re.useMemo=function(N,q){return O.H.useMemo(N,q)},re.useOptimistic=function(N,q){return O.H.useOptimistic(N,q)},re.useReducer=function(N,q,Mt){return O.H.useReducer(N,q,Mt)},re.useRef=function(N){return O.H.useRef(N)},re.useState=function(N){return O.H.useState(N)},re.useSyncExternalStore=function(N,q,Mt){return O.H.useSyncExternalStore(N,q,Mt)},re.useTransition=function(){return O.H.useTransition()},re.version="19.2.4",re}var Jg;function td(){return Jg||(Jg=1,ih.exports=Py()),ih.exports}var ah={exports:{}},Sn={};/**
 * @license React
