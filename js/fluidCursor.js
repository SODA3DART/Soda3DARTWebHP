...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.addEventListener('mousedown', (e) => {
    ...
    clickSplat(pointer);
    startAnimationIfNeeded(); // Start animation if not already started
  });
  ...
  window.addEventListener('touchstart', (e) => {
    ...
    for (let i = 0; i < touches.length; i++) {
      ...
      clickSplat(pointer); // Create a splat on touch
    }
    startAnimationIfNeeded(); // Start animation if not already started
  });
  ...
  // Don't start the animation until user interacts with the page
  // This helps reduce initial load on the browser
